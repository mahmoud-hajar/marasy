...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
     ...
     IQKeyboardManager.shared.enableAutoToolbar = true
        ...
        Helper.statusBar(colr: #colorLiteral(red: 0.7882352941, green: 0.1450980392, blue: 0.1725490196, alpha: 1))


//    UINavigationBar.appearance().setBackgroundImage(UIImage(named:"Bitmap.png")?.resizableImage(withCapInsets: UIEdgeInsets.zero, resizingMode: .stretch),
//                                                        for: .default)
